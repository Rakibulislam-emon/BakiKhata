    ...
    >
      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <m.button
          ...
          className="hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg shadow-emerald-500/30 transition-all"
